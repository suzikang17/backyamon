  ...
  return (
    <div className="animated-bg flex min-h-screen flex-col items-center justify-center px-4">
      ...
      <div className="text-center mb-12 animate-fade-in-up">
        <h1 className="title-glow font-spice text-4xl sm:text-6xl md:text-7xl lg:text-8xl text-[#FFD700] tracking-wide">
          Back Ya&apos;Mon!
        </h1>
      </div>

      {/* Rasta divider */}
      <div className="flex w-48 sm:w-64 mb-10 rounded overflow-hidden animate-fade-in animate-delay-200">
      ...
      <div className="flex flex-col gap-4 w-full max-w-xs sm:max-w-sm">
        <button
          ...
          className="animate-fade-in-up animate-delay-200 w-full rounded-2xl wood-btn wood-btn-green px-6 sm:px-8 py-3 sm:py-4 text-lg sm:text-xl font-bold text-[#FFD700] shadow-lg interactive-btn cursor-pointer hover:shadow-[0_0_20px_rgba(0,107,63,0.4)] font-heading"
        >
          Single Player
        </button>
        ...
        <Link
          href="/lobby"
          className="animate-fade-in-up animate-delay-300 w-full rounded-2xl wood-btn wood-btn-bamboo px-6 sm:px-8 py-3 sm:py-4 text-lg sm:text-xl font-bold text-[#1A1A0E] text-center shadow-lg interactive-btn hover:shadow-[0_0_20px_rgba(212,168,87,0.4)] font-heading"
        >
          Play Online
        </Link>
